...
<template>
  <div class="min-h-screen bg-slate-50 text-slate-900">
    <section class="bg-gradient-to-r from-purple-600 via-pink-500 to-purple-700 text-white py-20 px-6">
    ...
    <section class="max-w-7xl mx-auto px-6 py-10">
      <div class="flex items-center gap-2 text-sm text-slate-500 mb-8">
        ...
        <NuxtLink to="/women" class="hover:text-purple-600">
          Women
        </NuxtLink>
      ...
      <div
        v-if="loading"
        class="py-20 text-center text-slate-600"
      >
        Loading products...
      </div>
      ...
      <div
        ...
        class="py-20 text-center text-slate-600"
      >
        No products found. Add women products from Admin Products.
      </div>
        ...
        >
          <div class="relative">
            ...
            <button
              ...
              class="absolute top-4 right-4 w-12 h-12 rounded-full bg-white text-pink-600 shadow-lg hover:bg-pink-600 hover:text-white transition"
            >
              ❤️
            </button>
          </div>
          ...
          <div class="p-6">
            ...
            <div class="grid grid-cols-2 gap-3 mt-6">
              <button
                @click="addToWishlist(product)"
                class="bg-pink-50 text-pink-600 py-3 rounded-full font-bold hover:bg-pink-600 hover:text-white transition"
              >
                Wishlist
              </button>
              ...
              <button
                ...
                class="bg-slate-900 text-white py-3 rounded-full font-bold hover:bg-purple-700 transition disabled:opacity-50"
              >
                {{ product.status === 'sold_out' ? 'Sold Out' : 'Cart' }}
              </button>
            </div>
          </div>
        </div>
